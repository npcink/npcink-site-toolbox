...
required_files=(
  ...
  "includes/class-npcink-toolbox-helpers.php"
  "includes/class-npcink-toolbox-rate-limiter.php"
  "includes/class-npcink-toolbox-audit-logger.php"
  "includes/class-npcink-toolbox-site-health.php"
  ...
  "includes/class-npcink-toolbox-github-project.php"
  "includes/class-npcink-toolbox-rest-route-registry.php"
...
[ "$constant_count" = '1' ] || fail "expected one NPCINK_SITE_TOOLBOX_VERSION constant, found $constant_count"
