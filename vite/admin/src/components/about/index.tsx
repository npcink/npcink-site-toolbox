...
const AboutPlugin = () => (
  <div>
    <Paragraph>
      {__("这是一款完全免费且开源的插件，还在根据各位的使用和反馈，不断优化和增添新功能中。")}
    </Paragraph>
    <Paragraph>
    ...
    <Paragraph>
      {__("早期给公司的子主题添加各项功能，管理不便，便独立出来，方便统一管理和维护；随着进一步的发展，功能增多，独乐乐不如众乐乐，于是免费分享出来，供大家使用。")}
    </Paragraph>
  </div>
);
...
const Proposal = () => (
  <div>
    <Paragraph>
      {__("您可以通过以下方式，或通过下方联系方式，给出您的宝贵建议；我会酌情排期，实现有趣的功能。")}
    </Paragraph>
    <Paragraph>
      <ul style={{ paddingLeft: 20 }}>
        <li>
...
const AboutAndSupport = () => (
  <>
    <SettingsSection title={__("关于插件")}>
      <AboutPlugin />
    </SettingsSection>
    <SettingsSection title={__("我有建议")}>
      <Proposal />
    </SettingsSection>
    <SettingsSection title={__("联系方式")}>
      <Links />
    </SettingsSection>
    <SettingsSection title={__("来源")}>
      <Source />
    </SettingsSection>
  </>
);
