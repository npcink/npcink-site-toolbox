...
const App: React.FC = () => {
  ...
  return (
    <SettingsSection title={__("站点")} description={__("站点基础优化设置")}>
      <Form
        name="site"
      ...
      >
        <ModuleRow
          title={__("隐藏顶部工具条")}
          description={__("对无法编辑文章的登录用户隐藏前台顶部工具条")}
        ...
        <ModuleRow
          title={__("移除版本信息")}
          description={__("从RSS源和网站中删除WordPress版本信息，如果您无法保持您的WordPres版本为最新，推荐开启")}
        ...
        />
        <ModuleRow
          title={__("禁止title中的 \"-\" 被转义")}
          description={__("让网页标题符号正常显示")}
        ...
        <ModuleRow
          title={__("分类链接简化")}
          description={__("去掉分类目录链接中的 category 字符，修改后旧链接可能失效")}
        ...
        <ModuleRow
          title={__("搜索链接优化")}
          description={__("将 ?s=关键词 改为 域名/search/关键词，部分主题可能不兼容")}
        ...
        />
        <ModuleRow
          title={__("安全 - 移除 wp-sitemap-users")}
          description={__("移除原生站点地图中的用户信息部分，可减少用户信息暴露风险")}
        ...
        <ModuleRow
          title={__("用户列表展示昵称")}
          description={__("在用户列表中以“昵称”列替代“姓名”列")}
