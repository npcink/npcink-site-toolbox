...
const App: React.FC<OptimizeProps> = ({ targetItemId }) => {
  const tabs: SettingsTab[] = [
    { key: "site", label: __("站点"), prefixes: ["optimize-site-"], content: <Site /> },
    { key: "media", label: __("媒体"), prefixes: ["optimize-medium-"], content: <Medium /> },
    { key: "admin", label: __("后台"), prefixes: ["optimize-admin-"], content: <Other /> },
  ];

  return (
    <SettingsTabs
      ariaLabel={__("站点与媒体分组")}
      idPrefix="mabox-site"
      tabs={tabs}
