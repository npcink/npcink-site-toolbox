...
export default defineConfig({
  ...
  themeConfig: {
      ...
      '/features/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '用户评论 REST 接口', link: '/features/page-comment/user-comment-rest-api' },
          ],
        },
        {
          text: '页面功能',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/npcink/npcink-site-toolbox' },
    ...
    editLink: {
      pattern: 'https://github.com/npcink/npcink-site-toolbox/edit/main/docs-site/:path',
      text: '在 GitHub 上编辑此页',
    },
